...
ROOT_DIR_home = os.getcwd()
#root_dir_jpg = os.path.join(ROOT_DIR_home, "zoo2Main")
root_dir_jpg = os.path.join(ROOT_DIR, "MaskDetection/zoo2Main")
...
DEFAULT_LOGS_DIR = os.path.join(ROOT_DIR_home, "logs")
